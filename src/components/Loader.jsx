   ...
   return (
      <div className="">
         <div className="spinner w-100 h-100 flex justify-center items-center gap-2">
            ...
            <span className="spinner-circle w-10 h-10 rounded-full bg-blue-700 opacity-0 animate-fade animation-delay-300"></span>
            <span className="spinner-circle w-10 h-10 rounded-full bg-blue-700 opacity-0 animate-fade animation-delay-600"></span>
