   ...
   return (
      <div className="w-full">
         ...
         <select
            ...
            id={id}
            ref={ref}
            className={`p-2 ml-1 rounded-lg bg-white text-black outline-none focus:bg-gray-50 duration-300 border border-gray-200 dark:bg-background-darkGray dark:text-text-dark ${className}`}
         >
            {options?.map((option) => (
